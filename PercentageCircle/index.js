            ...
            <View style={[styles.circle, {
                ...
                <View style={[styles.leftWrap, {
                    ...
                    <View style={[styles.loader, {
                        ...
                        transform: [{ translateX: -this.props.radius / 2 },
                          { rotate: this.state.leftTransformerDegree }, { translateX: this.props.radius / 2 }],
                    }]} />
                </View>
                <View style={[styles.leftWrap, {
                    left: this.props.radius,
                    ...
                    <View style={[styles.loader, {
                        ...
                        transform: [{ translateX: this.props.radius / 2 },
                          { rotate: this.state.rightTransformerDegree }, { translateX: -this.props.radius / 2 }],
                    }]} />
                </View>
